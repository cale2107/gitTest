...
?>
	...
	<header>
            	...
            	<ul class="category-nav left">
                	<li class="blue">
                        ...
                        <ul>           
                        	...
                        	<li class="orange"><a href="vlasnici.php">Vlasnici</a></li>
                        </ul>
                    </li>
                </ul>
				<ul class="left">
		...
		<nav>
			<ul>
				...
				<li class="cooperation active"><a href="saradnja-sa-uvmps.php">SARADNJA SA UVMPS</a></li>
    ...
    <div class="breadcrumbs tight">
    	<ul class="clearfix">
        	...
        	<li><span>Saradnja sa UVMPS</span></li>
        </ul>
    </div><!-- / Breadcrumbs -->
    
	<div class="wrapper uvmps news">

		<h1>SARADNJA SA UDRUŽENJEM VETERINARA MALE PRAKSE SRBIJE - UVMPS</h1>
		...
		<h2 class="blue-title">PREDSTOJEĆI DOGAĐAJI</h2>
